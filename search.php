                ...
                <div class="card-body">
                    <form action="" id="search_movie">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-border" placeholder="Search Here" name="search" required>
                        </div>
                        <div class="form-group mt-3 text-center">
                            <button class="btn btn-primary btn-flat col-4"><i class="fa fa-search"></i> Search Movie</button>
                        </div>
                    </form>
                </div>
            </div>
